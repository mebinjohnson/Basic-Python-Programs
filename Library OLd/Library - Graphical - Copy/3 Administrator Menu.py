...
if select=='1':
    ...
    execfile("33 Create Book.py")
elif select=='4':
    execfile( "34 Books Record.py")
elif select=='5':
    execfile("35 Delete Book.py")
elif select=='6':
    execfile( "36 View Book.py")
elif select=='7':
    execfile("37 View Student.py")
elif select=='8':
    execfile("38 View Issued Books.py")
elif select=='9':
    execfile( "0 Main.py")
else:
