...
adno=int(raw_input("Enter the Admssion Number of Student : "))
...
pos=-1
for x in list:
   if int(x.student_no)==adno:
            print "\tMatch Found with Student-",x.student_name
            pos=x
            break
...
while pos!=-1:
    ...
    if selct=='1':
       ...
       #print  new_name
        ...
        pos.student_grade=raw_input("Enter New Grade : ")
        
    elif selct=='3':
        new_section=raw_input("Enter New Section : ")
